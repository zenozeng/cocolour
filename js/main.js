  ...
  box.ondrop = function(event) {
    ...
    colorsClustering(config, function(clusters) {
      ...
      html = schemes.map(function(colors) {
        ...
        return "<div class='scheme'>" + (tmp.join('')) + "        <i class='fa fa-heart-o button'></i>        <i class='fa fa-trash-o button'></i></div>";
      });
      document.getElementById("schemes").innerHTML = html.join('');
      return $('.scheme .button').click(function() {
        $scheme;
...
},{"jquery":2,"colors-clustering":3}],2:[function(require,module,exports){
(function(){/*!
...
},{"./lib/clustering.js":4,"canvas-browserify":5}],5:[function(require,module,exports){
...
},{"./CIE76.js":6,"./seeds.js":7,"color-convert":8}],8:[function(require,module,exports){
...
},{"./conversions":9}],9:[function(require,module,exports){
/* MIT license */
