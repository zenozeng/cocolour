...
(function() {
  var calcDistance, clustering, clusteringWrapper, hypot, math, rgb2hsl;
  ...
  clustering = function(points, config) {
    ...
    calc = function() {
      ...
      if (debug) {
        return typeof display === "function" ? display(centers) : void 0;
      }
    };
    calc();
    calc();
  ...
  clusteringWrapper = function(config, callback) {
    ...
    img.onload = function() {
      ...
      centers = clustering(points, {
        debug: true,
        display: display
      });
      return typeof callback === "function" ? callback(centers) : void 0;
    };
    return img.src = url;
  };
