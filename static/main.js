...
},{"./views/user-view.coffee":2,"./views/explore-view.coffee":3,"./views/image-view.coffee":4,"./views/favorite-view.coffee":5,"jquery":6}],7:[function(require,module,exports){
(function() {
  var fitness;
...
(function() {
  ...
  UserView = (function() {
    ...
    UserView.prototype.html = function() {
      var html, user;
    ...
    UserView.prototype.bind = function(AV) {
      ...
      $('#user').on('click', '#logout', function() {
        AV.User.logOut();
        return self.html();
      });
      $('#reset-password-button').click(function() {
        return $('#password-reset').show();
      });
      $('#password-reset .submit').click(function() {
        var $this, email, handler;
      ...
      $('#signup .submit').click(function() {
        var $this, email, handler, password, user, username;
        user = new AV.User();
...
},{"./schemes-view.coffee":8,"jquery":6}],5:[function(require,module,exports){
(function() {
...
},{"./schemes-view.coffee":8,"jquery":6}],4:[function(require,module,exports){
(function() {
...
},{"../fitness.coffee":7,"./schemes-view.coffee":8,"gene-pool":9,"jquery":6,"colors-clustering":10}],11:[function(require,module,exports){
(function() {
  var generate;
...
},{"./detail-view.coffee":12,"jquery":6}],9:[function(require,module,exports){
...
},{"./gene-pool":13}],13:[function(require,module,exports){
// genes: 基因库
// n: 单个个体基因数
...
},{"./lib/clustering.js":14,"canvas-browserify":15}],15:[function(require,module,exports){
...
(function() {
  var $, AV, DetailView, actPalette, download, generateFilename, gimpPalette;
  ...
  DetailView = (function() {
    ...
    DetailView.prototype.show = function(colors) {
      ...
      if (!($('#palette-detail-wrapper').length > 0)) {
        ...
        $('#palette-detail').on('click', function(e) {
      ...
      $('#palette-detail-colors').html(colors.map(function(color) {
        var hex, rgb;
        rgb = color.join(', ');
      ...
      return $('#palette-detail-wrapper').fadeIn();
    };

    DetailView.prototype.hide = function() {
      return $('#palette-detail-wrapper').fadeOut();
    };
...
},{"../lib/gimp-palette.coffee":11,"jquery":6,"act-js":16}],17:[function(require,module,exports){
// Generated by CoffeeScript 1.7.1
(function() {
  var CIE76;
...
},{"./CIE76.js":17,"./seeds.js":18,"color-convert":19}],19:[function(require,module,exports){
...
},{"./conversions":20}],20:[function(require,module,exports){
/* MIT license */
